          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <button className="btn btn-supplier">{userName}/ Owner</button>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-dark">
                  <li><Link className="dropdown-item" to="/owner/livestock-form">Add Livestock</Link></li>
                  <li><Link className="dropdown-item" to="/owner/view-livestock">View Livestock</Link></li>
                </ul>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/owner/view-feed">Feed</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/owner/my-request">My Requests</Link>
              </li>
              <li className="nav-item">
